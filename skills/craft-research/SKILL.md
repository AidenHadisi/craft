...
2. **Research thoroughly.** Dispatch multiple subagents to find authoritative information from many angles. They should search for official documentation, research papers, whitepapers, technical articles from recognized experts, books, online references, real-world case studies, tutorials, codebases, production examples, known pitfalls, trade-offs, and failure modes. Each subagent covers a different angle so you get broad, deep coverage. Prioritize reliable, professional sources over random forum posts.
