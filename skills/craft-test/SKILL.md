...
- When a failure needs more visibility, delegate log reading or add logging deeper along the path — don't guess from the outside.
...
- Delegate curl of the new/changed endpoints with real request bodies; verify status codes and response shapes.
