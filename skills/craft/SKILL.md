---
name: craft
description: End-to-end workflow for planning and building a feature. Quick mode (default) explores, writes a directive-level plan, gets one approval, and implements with parallel coders. Detailed mode — only when the user explicitly asks for it — adds an interview, design options, a spec, and a reviewed literal-code plan. Use when the user wants to plan AND build a feature, says "craft this", or asks for a high-quality implementation.
---
